    ...
    return (
        <>
            <div className='travel--card'>
                <img alt="location" className='mainImage' src={props.item.imageUrl} />
                <div>
                    ...
                    <span className="location">{props.item.location.toUpperCase()}</span>
                    <a href={props.item.googleMapsUrl}><span className='location--map'>View on Google Maps</span></a>
